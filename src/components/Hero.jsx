...
const Hero = () => {
  return (
    ...
    <section id='intro' className='top-4 flex lg:flex-row flex-col'>
      ...
      <div className="lg:h-[80vh] h-[35vh] lg:w-[100vw] w-[100vw] p-8 text-5xl flex flex-col justify-center text-black lg:items-start items-center">
        ...
        <p className='lg:text-lg text-lg lg:mt-4 mt-2 '>I'm a skilled web designer with experience in creating<br/> visually appealing and user friendly websites.</p>
