...
const Hero = () => {
  return (
    ...
    <section id='intro' className='top-4 flex lg:flex-row flex-col'>
      ...
      <div className="lg:h-[80vh] h-[30vh] lg:mt-0 mt-16 lg:w-[100vw] w-[100vw] p-8 text-5xl flex flex-col justify-center text-black lg:items-start items-center">
        <span className='text-3xl mb-2.5 flex font-semibold'>Hello <img src={hi} alt="Hi Emoji" className='object-cover h-8 w-8 ml-2 ' /> </span>
        <span className='lg:text-7xl text-4xl font-semibold font-Poppins justify-start lg:text-left text-center '>I'm<span className='text-violet-400'> Aakash</span><br/>Web Designer</span>
        <p className=' text-lg lg:mt-4 lg:w-[40rem] mt-2 lg:justify-start text-center lg:text-left '>I'm a skilled web designer with experience in creating<br className='hidden'/> visually appealing and user friendly websites.</p>
      ...
      <div className='hero lg:mr-8 lg:mt-0 mt-14'>
      </div>
    </section>
