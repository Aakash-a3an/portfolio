      ...
      <div id='about' className='flex justify-center lg:m-0 m-12 items-center lg:h-[100vh]'>
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center w-full">
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> React Js </button>
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> Python </button>
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> Javascript </button>
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> SQL </button>
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> NoSQL </button>
            <button className='bg-black hover:bg-violet-400  py-2 px-3 w-24 flex-col items-center m-4 rounded-full text-white shadow-2xl'> Node Js </button>
          </div>
        </div>
      </div>
    </>
