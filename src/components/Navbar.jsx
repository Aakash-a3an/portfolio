...
const Navbar = () => {
  return (
    <nav className="navbar h-[5rem] w-[100vw] mx-auto px-4 py-8 flex items-center justify-between max-w-[75rem] sticky top-0 z-20 bg-white">
      <h1 className='font-Sugiyama lg:text-5xl text-2xl cursor-pointer'><Link to='intro' spy={true} smooth={true} offset={-100} duration={500} >Aakash</Link></h1>
      ...
      <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-40} duration={500}><button className='flex bg-black text-white transition duration-200 rounded-[5rem] lg:px-3 px-2 lg:py-2 py-1 lg:pr-4 pr-4 items-center border  border-gray-300 hover:border-transparent hover:shadow-md dark:hover:shadow-xl font-semibold'> <FiMessageSquare className='m-2'/>
