...
const Contact = () => {
  ...
  return (
    <div id="contact" className='flex justify-center flex-col items-center h-[100vh] w-[vw]'>
      <div className='lg:h-[31rem] h-[32rem] lg:w-[60rem] w-[30rem] flex justify-center rounded-2xl flex-col items-center bg-[#eeb4ff] shadow-xl'>
      ...
      <form className='flex flex-col w-[90vw] lg:max-w-[60rem] max-w-[25rem] font-medium justify-center items-center' ref={form} onSubmit={sendEmail}>
        ...
        <button className='bg-[#d64aff] shadow-xl text-white font-Poppins font-semibold h-8 w-48 rounded-lg ' value='send' type="submit">Submit</button>
      </form>
      </div>
    </div>
  )
